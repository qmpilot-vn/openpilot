...
# VF8/VF9 LongControl stop-hold only (not re-engage). 30% softer than stock -2.0 / 0.8.
VINFAST_STOP_ACCEL = {"VINFAST_VF8": -1.4, "VINFAST_VF9": -1.4}
VINFAST_STOPPING_DECEL_RATE = {"VINFAST_VF8": 0.56, "VINFAST_VF9": 0.56}
