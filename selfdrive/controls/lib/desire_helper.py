...
# From vf-release-c4: VinFast carstate latches steeringPressed at STEER_DRIVER_PRESS_NM
# (2.0) for 15 frames so EPS noise (~1 Nm) does not chatter override. A lane-change
# tap is the same ~1 Nm signal and is usually gone before that latch fills.
