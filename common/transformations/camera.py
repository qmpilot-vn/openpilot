...
# 650 tuned for non-Comma C3XL clone ecam (Comma stock was 567; magnification still not consistent across frame)
_ar_ox_fisheye = CameraConfig(1928, 1208, 650.0)
